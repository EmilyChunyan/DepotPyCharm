...
try:
    ...
    options = webdriver.EdgeOptions()  # Création des options du navigateur chrome
    # créer et ouvrir une nouvelle du navigateur chrome
    driver = webdriver.Edge(options=options)  ##initialisation du webdriver pour chrome avec les options par spécifiques defaut
